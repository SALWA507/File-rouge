...
function Maintenance() {
    ...
    const deleteMaintenance = async (id) => {
        if (
            !window.confirm(
                "Êtes-vous sûre de vouloir supprimer cette maintenance ?"
            )
        ) {
            return;
        }
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] p-8">
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <button
                    onClick={() => setAddMaintenance(true)}
                    ...
                    maintenances.map((maintenance) => (
                        ...
                        >
                            ...
                            <div className="flex items-start justify-between gap-4">
                                ...
                                <span className="shrink-0 px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap bg-blue-100 text-blue-700">
                                    {maintenance.status}
                                </span>
                            </div>
                        ...
                        <div className="px-5 py-4 space-y-3">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value={
                                        selectedMaintenance.plannedDate
                                            ? selectedMaintenance.plannedDate.substring(
                                                  0,
                                                  10
                                              )
                                            : ""
